...
public class ViewModel {
    private static MutableLiveData<List<Commodity>> _allCommoditiesLiveData = new MutableLiveData<>(Collections.emptyList());
    public static LiveData<List<Commodity>> allCommoditiesLiveData = _allCommoditiesLiveData.asLiveData();

    private static MutableLiveData<Commodity> _commodityLiveData = new MutableLiveData<>();
